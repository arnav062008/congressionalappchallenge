...
class _MapPointScreenState extends State<MapPointScreen> {
  ...
  List<MapPoint> _updateMapPointsFromSnapshot(QuerySnapshot snapshot) {
    List<MapPoint> mapPoints = [];
      ...
      body: _initialPosition == null
          ...
          : StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  final updatedMapPoints =
                      _updateMapPointsFromSnapshot(snapshot.data!);
                  _mapPoints = updatedMapPoints; // Update the state here
                  return _buildMapWidget(mediaQuery);
  ...
  Widget _buildMapWidget(MediaQueryData mediaQuery) {
    return Stack(
      children: [
        GoogleMap(
